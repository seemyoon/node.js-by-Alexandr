...
export const configs = {
    ...
    ACTION_VERIFY_PASSWORD_SECRET: process.env.ACTION_VERIFY_PASSWORD_SECRET,
    ACTION_VERIFY_PASSWORD_EXPIRATION: process.env.ACTION_VERIFY_PASSWORD_EXPIRATION,
